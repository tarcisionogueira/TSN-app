 ...
 * que é sinal de venda, sem duplicar a lógica.
 */
...
export default async function handler(req, res) {
  ...
  const rRow = await sb(`${tabela}?id=eq.${encodeURIComponent(id)}&select=id,${colunaUrl},resultado_leilao,valor_lance_vencedor,resultado_apurado_em,resultado_apuracao_tentativas&limit=1`);
