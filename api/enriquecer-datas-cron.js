...
export default async function handler(req, res) {
  ...
  const filtro = [
    ...
    'select=id,link_edital,url_lote,modalidade',
  ...
  res.status(200).json({ ok: true, processados: candidatos.length, com_data: comData, sem_conteudo: semConteudo });
}
