-- Adiciona score_localizacao ao retorno da RPC de busca por raio, para o Score
-- BidPro em camadas ter a camada de localização também no modo raio (paridade com
-- a lista sem raio, que usa select('*')). Mantém a correção de valor nulo.
