/**
 * Descartável — regenera o relatório do terreno "Gênesis II" (Barueri/SP) para validar o
 * fix de cidade/rua/loteamento lidos da matrícula (commit ffab4fc). Espera: cidade corrigida
 * pra Santana de Parnaíba, endereço com "Alameda das Guaraunas", busca achando comparáveis
 * reais (o dono já confirmou 3 anúncios existentes via Google, publicados sob "Gênesis II").
 */
