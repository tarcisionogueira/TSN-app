...
const vs = await sb(`veiculos_leilao?ativo=eq.true&ano_fabricacao=is.null&ano_modelo=is.null&select=id,fonte,titulo,modelo,placa,chassi,anexos,link_lote&limit=${LIMITE}&order=fonte`);
