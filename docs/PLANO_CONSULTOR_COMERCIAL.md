...
> revela+registra → feedback na trilha. Concluídas F2 (tela /comercial) e F3 (atribuição ?ref + Admin). Concluída F4 (Atendimento com escopo). Concluída F5 (NPS). Falta só **F6** (CSV + invariantes qa).
