...
export const PLANOS = {
  ...
  assessorado: {
    ...
    precoLabel: 'R$ 500',
    precoVista: 5000,
    precoVistaLabel: 'R$ 5.000',
    periodicidade: '× 12 parcelas · ou R$ 5.000 à vista',
    honorarios: 10,
    cor: '#d97706',
    bg: '#fef3c7',
    homepage: false,
    ...
    pagamento_tipo: 'parcelado_fixo',
    acesso_meses: 12,
    vinculado_arrematacao: true,
    descricao: 'Assessoria completa da equipe TSN para realizar 1 arrematação em até 12 meses. Prazo pode ser estendido pelo admin até a posse.',
    recursos: [
      '✅ Tudo do plano Investidor Pro',
      '✅ Cursos gravados e eBooks inclusos',
      '✅ Assessoria para 1 arrematação completa (12 meses ou até a posse)',
      ...
      '✅ Orientação pós-arrematação (imissão de posse e registro)',
      '✅ Prazo extensível pelo admin até a conclusão da posse',
  ...
  clube: {
    ...
    precoLabel: 'R$ 5.000',
    precoVista: 48000,
    precoVistaLabel: 'R$ 48.000',
    periodicidade: '/mês · 12 meses · ou R$ 48.000 à vista',
    honorarios: 10,
    cor: '#059669',
    bg: '#d1fae5',
    homepage: false,
    ...
    descricao: 'Mentoria contínua, assessoria e arrematações ilimitadas. Fidelidade de 12 meses; após isso cancele a qualquer momento sem multa.',
    recursos: [
      ...
      '✅ Fidelidade de 12 meses — após isso, cancele a qualquer momento',
      '✅ Cancelamento antecipado: multa de 30% do saldo restante da fidelidade',
