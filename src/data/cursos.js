...
export const PLANOS = {
  ...
  clube: {
    ...
    preco: 5000,
    precoLabel: 'R$ 5.000',
    periodicidade: '/mês · fidelidade mínima de 12 meses',
    ...
    recursos: [
      ...
      '✅ Fidelidade de 12 meses — após esse período, cancele a qualquer momento',
...
export const ROLES = {
  ...
  top1:        { nome: 'TOP 1', tipo: 'plano', descricao: 'Relatório de viabilidade do imóvel' },
  top2:        { nome: 'TOP 2', tipo: 'plano', descricao: 'Relatório + análise jurídica documental' },
