...
export const PLANOS = {
  ...
  top1: {
    ...
    homepage: true,
    destaque: true,
    descricao: 'Relatório completo de viabilidade do imóvel',
    recursos: [
      '✅ Tudo do Explorador',
      '✅ Relatório mercadológico',
      '✅ Viabilidade financeira com projeções',
      '✅ Fluxo de caixa de 12 meses de operação',
      '✅ Valor real de mercado com evidências',
  ...
  top2: {
    ...
    homepage: true,
    destaque: false,
    descricao: 'Relatório de viabilidade + análise jurídica documental',
    recursos: [
      '✅ Tudo do Investidor',
      '✅ Relatório de análise de edital e matrícula',
  ...
  assessorado: {
    ...
    homepage: false,
    destaque: false,
    descricao: 'Assessoria completa da equipe TSN para realizar 1 arrematação em até 12 meses',
    recursos: [
      '✅ Tudo do Investidor Pro',
      '✅ Cursos gravados e eBooks gratuitamente',
  ...
  clube: {
    ...
    homepage: false,
    destaque: true,
    descricao: 'Mentoria contínua, assessoria e arrematações ilimitadas por 12 meses',
    recursos: [
      ...
      '✅ Fidelidade de 12 meses (R$ 60.000 no total) — ou R$ 48.000 à vista',
