...
export const PLANOS = {
  explorador: {
    ...
    recursos: [
      ...
      '✅ 3 relatórios mercadológicos e viabilidade financeira de amostra (uso único, não renovam)',
      '✅ Flag de viabilidade (🟢/🔴)',
      '✅ Direcionamento ao site do leiloeiro',
      '✅ Cursos gratuitos (Destravando Leilões + Leilão Seguro)',
      '❌ Análise Documental e Jurídica (edital/matrícula/processo)',
      '❌ Reunião com analista',
    ],
    limite_analises: 3,
    relatorio: false,
    portfolio: false,
  ...
  assessorado: {
    ...
    honorarios: '+10% de honorários sobre o valor arrematado',
    cor: '#d97706',
    bg: '#fef3c7',
    homepage: false,
    destaque: false,
