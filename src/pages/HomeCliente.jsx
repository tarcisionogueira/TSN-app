...
const TERMO_PARCEIRO_VERSAO = 'v5-2026-07';
...
const TERMO_PARCEIRO = [
  ...
  { t: '2. Elegibilidade', d: 'Para participar você deve ser maior de 18 anos, manter uma assinatura ativa (paga) e um cadastro completo e verídico (nome, CPF, telefone). Para RECEBER, é necessário cadastrar uma empresa (pessoa jurídica) da qual você seja sócio — ver item 5. Dados falsos impedem o pagamento e podem encerrar a participação.' },
  ...
  { t: '5. Pagamento (modelo B2B / pessoa jurídica)', d: 'Os repasses são pagos por PIX, semanalmente (às sextas-feiras), após conferência, para a conta de uma EMPRESA (pessoa jurídica) da qual você é sócio, mediante emissão de nota fiscal de prestação de serviços à BidPro Brasil. Para liberar o saque, você cadastra o CNPJ, a razão social e a chave PIX da empresa. Caso ainda não tenha, é possível abrir um MEI. Enquanto não houver empresa cadastrada, o saldo apurado fica retido e disponível para saque assim que o cadastro da PJ for concluído.' },
