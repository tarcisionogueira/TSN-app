...
const TERMO_PARCEIRO_VERSAO = 'v3-2026-07';
...
const TERMO_PARCEIRO = [
  ...
  { t: '8. Proteção de dados (LGPD)', d: 'O tratamento segue a Lei nº 13.709/2018 (LGPD) e a Política de Privacidade da BidPro Brasil. Na tela "Minha Rede" você visualiza apenas o NOME e a CIDADE/UF das pessoas da sua rede — nunca telefone, e-mail, endereço completo ou qualquer contato. Esses dados são disponibilizados só para você acompanhar o Programa: ao acessá-los você atua como CORRESPONSÁVEL pelo tratamento e se compromete a NÃO usá-los para outra finalidade, não copiá-los e não repassá-los a terceiros. Para prevenção a fraudes, registramos metadados do seu aceite e transações (data/hora, IP e dispositivo).' },
