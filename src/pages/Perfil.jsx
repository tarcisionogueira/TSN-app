...
export default function Perfil() {
  ...
  async function armazenarDoc(file, tipo, prefixo) {
    ...
    // (`assinarPathPrivado` em api/validar-selfie.js). A tentativa de `createSignedUrl` aqui era
    // vestigial — o cliente não tem permissão de assinar neste bucket, então ela SEMPRE falhava
    // com 400 e o handler global registrava o erro em `erros_cliente`. Ruído que escondia erro
