  ...
  useEffect(() => {
    ...
    supabase.from('imoveis_leilao').select('*').eq('id', id).single()
      .then(({ data }) => {
        ...
        // Mapeamento único em `src/utils/imovelDaLinha.js` (29/08) — a triagem passou a
        // precisar do mesmo objeto, e duas cópias divergem sem ninguém notar.
        setImovel(imovelDaLinha(data));
      })
      .finally(() => setLoading(false));
  }, [id]);
