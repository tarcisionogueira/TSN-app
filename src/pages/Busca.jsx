                ...
                <div key={im.id}
                  ...
                  <div style={{ display:'flex', flexDirection: isMobile ? 'column' : 'row', gap:0 }}>
                    ...
                    <div style={{ width: isMobile ? '100%' : 160, height: isMobile ? 160 : 110, flexShrink:0, background:'#f1f5f9', display:'flex', alignItems:'center', justifyContent:'center', overflow:'hidden', position:'relative' }}>
                      {im.foto
                        ? <img src={im.foto} alt="foto" referrerPolicy="no-referrer" crossOrigin="anonymous" style={{ width:'100%', height:'100%', objectFit:'cover', display:'block' }} onError={e=>{ e.currentTarget.style.display='none'; e.currentTarget.nextSibling.style.display='flex'; }}/>
                        : null}
