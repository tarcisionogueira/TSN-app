  ...
  return (
    <div style={{ background: '#f8fafc', minHeight: '100vh' }}>
      <div style={wrap}>
        ...
        <p style={{ marginTop: 10 }}><strong>Visibilidade da sua rede (minimização de dados):</strong> na tela "Minha Rede", um parceiro visualiza <strong>apenas o nome e a cidade/UF</strong> das pessoas da sua própria rede de indicações — <strong>nunca telefone, e-mail, endereço completo ou qualquer dado de contato</strong>, que permanecem acessíveis somente a quem os coletou diretamente. Esses dados são disponibilizados exclusivamente para o parceiro acompanhar o programa; ao usá-los, o parceiro assume a condição de <strong>corresponsável</strong> pelo tratamento e compromete-se a não utilizá-los para qualquer outra finalidade (LGPD, Art. 42 e seguintes). O administrador da plataforma pode visualizar as redes para fins de gestão e conformidade.</p>
