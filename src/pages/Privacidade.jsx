  ...
  return (
    <div style={{ background: '#f8fafc', minHeight: '100vh' }}>
      <div style={wrap}>
        ...
        <h1 style={{ fontSize: 32, fontWeight: 900, color: '#0f172a', margin: '0 0 6px' }}>Política de Privacidade (LGPD)</h1>
        ...
        <p>Para exercer seus direitos ou tirar dúvidas sobre privacidade, contate <a href="mailto:tarcisioaraujo@reimob.com.br" style={{ color: '#2563eb', fontWeight: 700 }}>tarcisioaraujo@reimob.com.br</a>.</p>
      </div>
    </div>
  );
}
